...
const DrivingLicense = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      {/* Additional Text */}
      <Text style={styles.title}>Driving License Details</Text>
      <Text style={styles.subtitle}>
      Please upload a focused photo of your PAN card for 
      faster verification
      </Text>
      ...
      <View style={styles.rectangleBox}>
        ...
        Front side photo of your Driving License with your 
